...
export const MOCK_PRODUCTS: Product[] = [
  // ── COSMETICS ────────────────────────────────────────────────
  {
    ...
    shipping:
      "Free standard shipping on orders over $50. Express (2-day) available at checkout. International shipping to 40+ countries.",
  ...
  },
  {
    ...
    shipping: "Free standard shipping on orders over $50. Express available.",
