          ...
          <div className="lg:col-span-2">
            ...
            <address className="not-italic space-y-4 text-sm text-white/70">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:ranique.official@gmail.com" className="hover:text-brand-rose-light transition-colors">
                  ranique.official@gmail.com
                </a>
              </div>
              <div className="flex items-center gap-3">
            ...
            <div className="mt-8 flex gap-4">
              <a href="https://www.instagram.com/ranique.official/" aria-label="Instagram" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-brand-rose hover:border-brand-rose transition-all group">
