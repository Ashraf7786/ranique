  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-brand-sand">
      <div className="max-w-md w-full space-y-8 bg-white p-8 sm:p-10 rounded-2xl shadow-sm border border-gray-100">
        <div>
          <h2 className="mt-6 text-center text-3xl font-serif font-bold text-brand-ink">
            Welcome back
          </h2>
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/forgot-password" className="text-xs font-medium text-brand-rose hover:text-brand-rose-dark">
                  Forgot password?
                </Link>
              </div>
              <input
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link href="/register" className="font-semibold text-brand-rose hover:text-brand-rose-dark transition-colors">
              Create an account
            </Link>
          </p>
        </div>
