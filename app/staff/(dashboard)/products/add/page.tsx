    ...
    <form onSubmit={handleSubmit} className="pb-24 relative">
      ...
      <div className="flex items-center justify-between mb-6 sticky top-16 bg-gray-50 z-10 py-4 border-b border-gray-200">
        ...
        <div>
          ...
          <p className="text-sm text-yellow-600 font-medium mt-0.5">Note: Product goes live after Admin approval.</p>
        </div>
      </div>
        <div className="flex items-center gap-3">
          ...
          <button type="submit" disabled={loading}
            className="bg-brand-gold text-white px-8 py-3 rounded-xl font-medium hover:bg-brand-gold/90 transition-colors flex items-center gap-2">
